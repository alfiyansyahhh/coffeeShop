...
import map from '../png/map.svg'
import partner from '../png/partner.svg'
const ceklis = 'https://alfiyansyahhh.skom.id/gambar/ceklis.png'
const f1 = 'https://alfiyansyahhh.skom.id/gambar/image 22.png'
const f2  = 'https://alfiyansyahhh.skom.id/gambar/image 27.png'
const f3 = 'https://alfiyansyahhh.skom.id/gambar/image 30.png'
const ceklis2 = 'https://alfiyansyahhh.skom.id/gambar/Vector (3).png'
const robert = 'https://alfiyansyahhh.skom.id/gambar/Ellipse 175.png'
const bintang = 'https://alfiyansyahhh.skom.id/gambar/Vector (4).png'
const cristy = 'https://alfiyansyahhh.skom.id/gambar/Ellipse 175 (1).png'
const kim = 'https://alfiyansyahhh.skom.id/gambar/Ellipse 175 (2).png'
const team = "https://alfiyansyahhh.skom.id/gambar/team.png"
